...
<script type="text/javascript">
	...
	$.post("${pageContext.request.contextPath}/auth/roleAction_ajaxList",function(data){
		$(data).each(function(){
			//此处做了优化操作json序列化取消了级联查询function，和role
			$("#roleId").append("<input type='checkbox' name='roleIds' value='"+this.id+"'/>"+this.name+"&nbsp");
		});
...
<body class="easyui-layout" style="visibility:hidden;">
    ...
    <div region="center" style="overflow:auto;padding:5px;" border="false">
       <form id="form" method="post" action="${pageContext.request.contextPath }/user/userAction_add">
