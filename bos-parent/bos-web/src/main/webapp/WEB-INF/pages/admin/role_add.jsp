...
<script type="text/javascript">
	$(function(){
		...
		var setting = {
			data : {
				key : {
					title : "pId"//存放的是data中的属性名称，显示的是对应的值
				},
				simpleData : {
					enable : true
				}
		...
		$('#save').click(function(){
			...
			if(nodes != null && nodes.length != 0){
				...
				for(var i = 0 ; i < nodes.length ; i++){
					arr.push(nodes[i].id);//拿到每个节点的id值
				}
				var ids = arr.join(",");
				$("#functionIds").val(ids);
			}
...
<body class="easyui-layout">
		...
		<div region="center" style="overflow:auto;padding:5px;" border="false">
			<form id="roleForm" method="post" action="${pageContext.request.contextPath }/auth/roleAction_add">
