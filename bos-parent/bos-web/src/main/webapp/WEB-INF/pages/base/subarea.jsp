...
<script type="text/javascript">
	...
	$(function(){
		...
		$('#grid').datagrid( {
			...
			pagination : true,
			toolbar : toolbar,
			url : "${pageContext.request.contextPath}/bc/subAreaAction_pageQuery",
			idField : 'id',
			columns : columns,
		...
		$("#btn").click(function(){
		    //  调用 datagrid load 方法 
		    // 1: form 序列化 {}
		   var jsonObj = $("#searchSubAreaForm").serializeJson();
	...
	//  封装js 方法  基于Ｊｑｕｅｒｙ　　  serializeJson 函数名称
	//  该函数作用  将 表单数据序列化成 json对象　　调用方法：　form表单对象.serializeJson() 即可
...
<body class="easyui-layout" style="visibility:hidden;">
	...
	<div class="easyui-window" title="分区添加修改" id="addSubareaWindow" collapsible="false" minimizable="false" maximizable="false" style="top:20px;left:200px">
		...
		<div style="overflow:auto;padding:5px;" border="false">
			<form id="addSubareaForm" method="post" action="${pageContext.request.contextPath }/bc/subAreaAction_save">
...
<!-- 					</tr> -->
					<tr>
						<td>选择区域</td>
						<td>
						<!--   下拉框   option value  text -->
							<input class="easyui-combobox" name="region.id"  
    							data-options="mode:'remote',valueField:'id',textField:'name',url:'${pageContext.request.contextPath}/bc/regionAction_ajaxList'" />  
						</td>
					</tr>
					<tr>
						<td>关键字</td>
	...
	<div class="easyui-window" title="查询分区窗口" id="searchWindow" collapsible="false" minimizable="false" maximizable="false" style="top:20px;left:200px">
		<div style="overflow:auto;padding:5px;" border="false">
			<form id="searchSubAreaForm" action="${pageContext.request.contextPath }/bc/subAreaAction_download" method="post">
				<table class="table-edit" width="80%" align="center">
					<tr class="title">
